...
public class TeamData {
    ...
    public HashMap<String, COKPlayer> getPlayerList() {
        return playerList;
    }
    ...
    public void addBlocks(int punishBlocks, COKGame game) {
        this.blockBase.addBlocks(punishBlocks, game, this.getTeam());
    }
}
