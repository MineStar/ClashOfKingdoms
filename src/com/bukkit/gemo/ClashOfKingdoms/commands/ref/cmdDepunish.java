...
public class cmdDepunish
{
	private static String Description = "Depunish a player";
	private static String Syntax = "/cok depunish <playername>";
	private static String[] Examples = {"/cok depunish krababbel"};
